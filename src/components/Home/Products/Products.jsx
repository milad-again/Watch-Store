    ...
    <>
      <div className="container mx-auto px-2 sm:px-4">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
          {contextData.allProducts.slice(0, 4).map((productSection) => (
            <div
        ...
        <div className="flex justify-center mt-4 sm:mt-6">
          <Link to="/ProductsInfo">
            <button className="w-32 h-10 sm:h-12 bg-red-700 rounded-lg text-white text-sm transition-all duration-300 hover:scale-105 hover:bg-red-800">
              نمایش بیشتر...
            </button>
          </Link>
        </div>
